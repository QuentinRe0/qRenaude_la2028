...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : lun. 21 sep. 2026 à 15:25
...
INSERT INTO `athlete` (`id`, `prenom`, `nom`, `date_naiss`, `pays_id`, `sport_id`) VALUES
                                                                                       (1, 'Teddy', 'Rinner', '1989-04-07', 1, 1),
                                                                                       (2, NULL, 'Biles', NULL, 2, 3),
                                                                                       (3, 'Léon', 'Marchand', NULL, 1, 2);
...
INSERT INTO `epreuve` (`id`, `nom`, `id_sport`) VALUES
                                                    (1, '200m brasse', 2),
                                                    (2, '200m papillon', 2);
...
INSERT INTO `site` (`id`, `nom`, `emplacement`) VALUES
(1, ' SoFi Stadium ', '1001 S. Stadium Drive\r\nInglewood, CA 90301'),
(2, ' Intuit Dome ', '3939 West 102nd Street\r\nInglewood, CA 90303');
...
INSERT INTO `sport` (`id`, `nom`, `site_id`) VALUES
(1, 'judo', NULL),
(2, 'natation', 1),
(3, 'gym', NULL);
...
--
ALTER TABLE `epreuve`
  ADD CONSTRAINT `fk_epr_sport` FOREIGN KEY (`id_sport`) REFERENCES `sport` (`id`);

--
-- Contraintes pour la table `sport`
--
ALTER TABLE `sport`
  ADD CONSTRAINT `fk_site-id` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`);
COMMIT;
