...
public class DaoAthlete {
    ...
    public static ArrayList<Athlete> getLesAthletes(Connection cnx){
        ...
        try{
            requeteSql = cnx.prepareStatement("select a.id as a_id, a.nom as a_nom, a.prenom as a_prenom, a.date_naiss as a_date_naiss  p.id as p_id, p.nom as p_nom " +
            ...
            while (resultatRequete.next()){
                ...
                Athlete a = new Athlete();
                   ...
                   a.setDate_naiss(resultatRequete.getDate("a_date_naiss").toLocalDate());
